...
className="text-xs text-emerald-200 underline mt-1"
          >
            Switch Window
          </button>
        </div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <button 
                ...
                className="w-full text-left p-3 rounded-lg hover:bg-emerald-600 flex items-center justify-between"
              >
            ...
            <li>
              <button 
                ...
                className="w-full text-left p-3 rounded-lg hover:bg-emerald-600"
              >
                History
              </button>
            </li>
        ...
        <div className="border-t border-white/20 pt-4">
          <button 
            ...
            className="w-full text-left p-3 rounded-lg hover:bg-emerald-600 flex items-center gap-2"
          >
            Logout
          </button>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 mb-4 md:mb-6">
              <div className="text-center">
                ...
                <div className="flex flex-col gap-2 md:gap-3">
                  ...
                  >
                    тzбя,? {showAllTransactions ? 'Hide Others' : 'Call Others'}
                  </button>
